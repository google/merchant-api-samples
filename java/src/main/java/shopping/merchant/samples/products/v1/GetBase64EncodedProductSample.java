...
public class GetBase64EncodedProductSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // The raw, unencoded product ID.
    // Format: content_language~feed_label~offer_id
    // Example: en~US~sku123/special
    // This ID might contain characters like '/' which need encoding.
    String rawProductId = "en~US~sku123/special"; // Replace with your actual product ID
