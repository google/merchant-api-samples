...
namespace MerchantApi
{
    internal class Authenticator
    {
        ...
        private static readonly string TOKEN_FILE = "token.json";

        public static ICredential Authenticate(
            MerchantConfig config, string scope)
        {
            ...
            else if (File.Exists(oauthFilePath))
            {
                ...
                {
                    var clientSecrets = GoogleClientSecrets.FromStream(oauthFile).Secrets;
                    var userId = "unused";
        ...
        public static TokenResponse LoadToken(MerchantConfig config, string scope)
        {
        ...
        public static void StoreToken(MerchantConfig config, TokenResponse token)
        {
            var tokenFile = Path.Combine(config.ConfigDir, TOKEN_FILE);
